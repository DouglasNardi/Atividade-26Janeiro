// Fazendo a importação do Express, mustache, router
...
app.set('views', __dirname + '/views'); //pega o diretorio absoluto do projeto e aumenta para pasta view concantenando
